...
⑤ 身份类提问（"我是XX吗 / 我是XX本人吗"）：玩家的真实身份=「玩家的身份」字段+案件背景里的当事人人设，这是唯一事实。
   XX 与玩家身份一致（含同义称呼）才答「是」；XX 是案件里的其他任何人物（凶手、死者、其他角色名）一律答「否」。
   同一人物的不同称呼判断必须前后自洽，绝不允许"我是总裁吗"答否、"我是顾总吗"答是却两者实为同一人的矛盾
"""
